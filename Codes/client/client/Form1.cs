...
namespace client
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = "Client - Player 1";
            Control.CheckForIllegalCrossThreadCalls = false;

            attackButton.Click += new EventHandler(attackButtonClick);          
        ...
        { 
            ...
            attackCoords.Clear();
            ENEMY_RESULT.Text = "";
            client.BeginSend(message, 0, message.Length, 0, new AsyncCallback(sendInfo), client);
        }
        ...
        void receiveInfo()
        {
            ...
            while (true)
            {
                ...
                if (receivedInfo == "win")
                {
                    ...
                    PLAYER_RESULT.Text = "Player 1 Lose !";

                    ENEMY_RESULT.Text = "Player 2 Win !";
                ...
                else if (attackTurn)
                {
                    ...
                    if (enemyAttackResult != "missed")
                    {
                        ...
                        {
                            PLAYER_RESULT.Text = "Player 1 Win !";

                            ENEMY_RESULT.Text = "Player 2 Lose !";
